  ...
  useEffect(() => {
    sessionStorage.setItem(
      ...
      JSON.stringify({
        status: 'success',
        token:
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzZTliZWZjOWUzZGJjNWJhOWE0NzA4NyIsImlhdCI6MTY4MjQyMjA1MiwiZXhwIjoxNjkwMTk4MDUyfQ.bVMG0FI7m9F3LIz0Nvwe8lThhG1sX7bvO4jV83iKPZU',
        data: {
          ...
          image: '',
          password:
            '$2a$12$OdX.AB8Oiz6PEXohnREMjOtIy8h4/Ha3wPMHVcA/J373tQ0afoco2',
          role: '0',
          ...
          passwordtoken:
            '7f509dc18f2da94f0e367da9d8b49d625ba608f77e58f884639a71f47d5aae87',
          passwordtokenexp: '2023-02-21T12:34:15.964Z',
        },
      })
    );
  }, []);
