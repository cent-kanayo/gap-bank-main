                    ...
                    <Row className="justify-content-center">
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                ...
                                <p className="mb-4 ff-secondary">We thrive when coming up with innovative ideas but also
