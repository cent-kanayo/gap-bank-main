...
import { Alert, Button, Card, CardBody, CardHeader, Container, Col, DropdownItem, DropdownMenu, DropdownToggle, ListGroup, ListGroupItem, Progress, Row, UncontrolledDropdown } from 'reactstrap';
...
const Dashboard = () => {
    ...
    document.title = "GAP Bank | Account";
